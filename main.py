...
from mat import water_mat, UO2_mat, cladding_mat, mixed_with_Gd2O3_mat, helium_mat, tube_mat, absorber_mat
openmc.config['cross_sections']='/home/ann/PycharmProjects/1000/new_cross_sections.xml'
...
if __name__ == "__main__":
    materials = openmc.Materials([water_mat, UO2_mat, cladding_mat, mixed_with_Gd2O3_mat, helium_mat, tube_mat, absorber_mat])
    ...
    colors = {water_mat: (120, 120, 255), cladding_mat: 'black', UO2_mat: (0, 200, 0), mixed_with_Gd2O3_mat: (0, 100, 0), helium_mat: 'red'}
